      ...
      <div className="relative min-h-fit overflow-hidden bg-gray-100 container mx-auto ">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 container -mt-12 pb-5 md:mt-2 ">
          ...
          <div className="md:hidden flex gap-1 mx-auto justify-center w-full py-3 -ml-2">
            ...
            <span className="text-base font-semibold mt-1 text-gray-700">
              ACE CMS
            </span>
          </div>

          <div className=" py-0 pb-5 md:py-20 lg:py-24 text-center">
            <h1 className="text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-6">
            ...
            <div className="mt-10 ">
              <Link href="#contact"
                className=" text-white bg-sky-600 p-2 md:px-10 md:py-3  rounded-md font-semibold  transition"
              >
                Contact Us
              </Link>
            </div>
